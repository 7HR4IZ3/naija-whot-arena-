...
export function Dashboard() {
 ...
 <Link className="simple-practice" href="/game"><span><strong>Practise with Amaka</strong><small>No sign-in · Untimed · 2 players</small></span><ArrowRight size={20}/></Link>
 <div className="simple-footer"><Link href="/history">Resume a match →</Link><Link href="/rules"><BookOpen size={16}/> How to play</Link></div>
 </main>;
}
