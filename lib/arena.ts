...
export type MatchHistory = { active: MatchHistoryActive[]; completed: MatchHistoryCompleted[]; history?: MatchHistoryCompleted[]; leaderboard: { display_name: string; games: number; wins: number }[] };
